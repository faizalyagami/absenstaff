                    ...
                    <div class="card-body">
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="username" class="form-control" v-model="username" required autofocus autocomplete="off">
                                </div>
                            </div>
            ...
            if (this.password.length > 0) {
                this.$axios.get('/sanctum/csrf-cookie').then(response => {
                    this.$axios.post('api/login', {
                        ...
                        .then(response => {
                            console.log(response.data, window.Laravel.isLoggedin)
